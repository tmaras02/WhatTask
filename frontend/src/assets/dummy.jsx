...
export const ADD_BUTTON =
    "flex items-center gap-2 bg-gradient-to-r from-orange-600 to-yellow-400 text-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base"
export const STATS_GRID = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6"
export const STAT_CARD =
    "p-3 md:p-4 rounded-xl bg-white shadow-sm border border-orange-100 hover:shadow-md transition-all duration-300 min-w-0"
