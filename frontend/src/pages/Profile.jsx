    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='max-w-4xl mx-auto p-6'>
        ...
        <div className='flex items-center gap-4 mb-8'>
            <div className='w-16 h-16 rounded-full bg-gradient-to-br from-orange-600 to-yellow-400 flex items-center justify-center text-white shadow-md font-bold text-2xl'>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
            <section className={SECTION_WRAPPER}>
               <div className='flex items-center gap-2 mb-6'>
                   <UserCircle className='text-orange-500 w-5 h-5'/>
                  ...
                  {personalFields.map(({name, type, placeholder, icon:Icon}) => (
                    <div key={name} className={INPUT_WRAPPER}>
                        ...
                        <input
                            ...
                            className='p-1 w-full focus:outline-none text-sm' required/>
                    </div>
                  ))}
